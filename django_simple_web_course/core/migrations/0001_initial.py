    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('retake_policy', models.CharField(blank=True, choices=[('auto', 'Automatic'), ('email', 'Email Approval'), ('none', 'No Retakes')], default='auto', max_length=5)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question_instance', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='course_test_answer_instance', to='core.coursetestquestioninstance')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_test', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='core.coursetest')),
                ('course_test_instance', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='course_page_view_instances', to='core.coursetestinstance')),
                ('course_test_question', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='core.multiplechoicetestquestion')),
                ('course_view_instance', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='course_page_view_instances', to='core.courseviewinstance')),
                ('student', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='course_page_view_instances', to='core.student')),
            ],
            options={
                'abstract': False,
            },
